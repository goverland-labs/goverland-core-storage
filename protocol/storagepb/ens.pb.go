...
const file_storagepb_ens_proto_rawDesc = "" +
	"\n" +
	"\x13storagepb/ens.proto\x12\tstoragepb\"5\n" +
	"\x15EnsByAddressesRequest\x12\x1c\n" +
...
var (
	...
	file_storagepb_ens_proto_rawDescData []byte
)

func file_storagepb_ens_proto_rawDescGZIP() []byte {
	file_storagepb_ens_proto_rawDescOnce.Do(func() {
		file_storagepb_ens_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_storagepb_ens_proto_rawDesc), len(file_storagepb_ens_proto_rawDesc)))
	})
