...
const file_storagepb_dao_proto_rawDesc = "" +
	...
	"\x03dao\x18\x01 \x01(\v2\x12.storagepb.DaoInfoR\x03dao\"\xcd\x01\n" +
	...
	"\adao_ids\x18\x05 \x03(\tR\x06daoIdsB\b\n" +
	"\x06_queryB\v\n" +
	"\t_categoryB\b\n" +
	"\x06_limitB\t\n" +
	"\a_offset\"^\n" +
	...
	"\x06status\x18\x01 \x01(\bR\x06status2\xd0\x04\n" +
	"\x03Dao\x12@\n" +
	...
	"\x13PopulateTokenPrices\x12\x1d.storagepb.TokenPricesRequest\x1a\x1e.storagepb.TokenPricesResponseB\rZ\v.;storagepbb\x06proto3"
...
var file_storagepb_dao_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_storagepb_dao_proto_goTypes = []any{
	...
	(*Strategy)(nil),                       // 22: storagepb.Strategy
}
var file_storagepb_dao_proto_depIdxs = []int32{
	21, // 0: storagepb.DaoInfo.created_at:type_name -> google.protobuf.Timestamp
	21, // 1: storagepb.DaoInfo.updated_at:type_name -> google.protobuf.Timestamp
	22, // 2: storagepb.DaoInfo.strategies:type_name -> storagepb.Strategy
	...
	21, // 12: storagepb.Point.time:type_name -> google.protobuf.Timestamp
	...
	4,  // 20: storagepb.Dao.GetByID:output_type -> storagepb.DaoByIDResponse
	6,  // 21: storagepb.Dao.GetByFilter:output_type -> storagepb.DaoByFilterResponse
	9,  // 22: storagepb.Dao.GetTopByCategories:output_type -> storagepb.TopByCategoriesResponse
	12, // 23: storagepb.Dao.GetRecommendationsList:output_type -> storagepb.GetRecommendationsListResponse
	14, // 24: storagepb.Dao.GetTokenInfo:output_type -> storagepb.TokenInfoResponse
	17, // 25: storagepb.Dao.GetTokenChart:output_type -> storagepb.TokenChartResponse
	20, // 26: storagepb.Dao.PopulateTokenPrices:output_type -> storagepb.TokenPricesResponse
